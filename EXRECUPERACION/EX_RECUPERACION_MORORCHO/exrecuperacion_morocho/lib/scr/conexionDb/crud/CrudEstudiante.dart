...
class CrudEstudiante {
  ...
  Future<List<Estudiante>> obtenerTodos(int menu, String parametro, String parametro2) async {
    var dbConn = await conn.db;
    ...
    if (menu == 1 && parametro == 'fecha') {
      estudianteOrden.sort((a, b) => (a.getFecha.toLowerCase().compareTo(b.getFecha.toLowerCase()) ));
    } else if (menu == 0 && parametro == 'fecha') {
      estudianteOrden.sort((a, b) => (b.getFecha.toLowerCase().compareTo(a.getFecha.toLowerCase())));
    } else if (menu == 1 && parametro == 'apellido') {
      estudianteOrden.sort((a, b) => (a.getApellido.toLowerCase().compareTo(b.getApellido.toLowerCase())));
    } else if (menu == 0 && parametro == 'apellido') {
      estudianteOrden.sort((a, b) => (b.getApellido.toLowerCase().compareTo(a.getApellido.toLowerCase())));
    } else if (menu == 0 && parametro == 'apellido' && parametro2 == 'fecha'){
      estudianteOrden.sort((a, b) => (b.getApellido.toLowerCase().compareTo(a.getFecha.toLowerCase())));
    }
