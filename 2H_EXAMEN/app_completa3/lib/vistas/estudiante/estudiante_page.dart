...
class _EstudiantePageState extends State<EstudiantePage> {
  ...
  enviarCorreo(String correo, String nombre, String apellido, String celular) async{
              String username = 'jeancarlo.marchesini96@gmail.com';
              String password = 'pl33nkmldr7wx';
              ...
              final message = new Message()
                ...
                ..html = "<h1>Hola $nombre $apellido , su celular es: $celular</h1>\n<p>Hey! Here's some HTML content</p>";
