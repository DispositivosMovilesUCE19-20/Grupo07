...
class InicioOage extends StatefulWidget {
  String usuario;
  InicioOage({Key key, this.usuario}) : super(key: key);
  @override
  _InicioOageState createState() => _InicioOageState();
}

class _InicioOageState extends State<InicioOage> {
  String aux;
  @override
  void initState() {
