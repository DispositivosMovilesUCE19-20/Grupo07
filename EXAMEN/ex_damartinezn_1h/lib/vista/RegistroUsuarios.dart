...
//controller para regresar a txt
  ...
  String auxPalabras = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";

   verificar(String aux) {
    for (int i = 0; i < aux.length; i++) {
      for (int j = 0; i < 52; j++) {
        if (aux.substring(i, (i + 1)) == auxPalabras.substring(j, (j + 1))) {
          print(aux.substring(i, (i + 1)));
          print(auxPalabras.substring(j, (j + 1)));
        }
      }
    }
  }
                  ...
                  onPressed: () {
                    ...
                    if (suma >= 2) {
                      ...
                      if (_formStateKey.currentState.validate()) {
                        ...
                        resul = mensajeProvider.makePostRequest(User(
                            null,
                            nombre,
                            apellido,
                            cedula,
