          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new TextFormField(
                ...
                obscureText: true,
                //validator: _validarClave('vl'),
                validator: (value) => 
                    value.isEmpty && value.length < 8 && value.length > 8? 'La contraseña no cumple.' : null,
...
_validarClave(String clave){
  if(clave.isEmpty){
    return 'Escriba la clave';
  }
  if(clave.length < 8  && clave.length > 8){
    return 'El tamaño de la contraseña debe ser de 8 caracteres';
  }
}
